...
public class RunGameView extends JPanel {
    ...
    public static final double AI_TANK_INITIAL_ANGLE = Math.toRadians(210.0); //Math.toRadians(180.0);
    ...
    public static final String LIFE_BAR_FIVE_LIVES = "5_hearts.png";
    public static final String LIFE_BAR_FOUR_LIVES = "4_hearts.png";
    public static final String LIFE_BAR_THREE_LIVES = "3_hearts.png";
    public static final String LIFE_BAR_TWO_LIVES = "2_hearts.png";
    public static final String LIFE_BAR_ONE_LIVES = "1_hearts.png";
    public static final String LIFE_BAR_ZERO_LIVES = "0_hearts.png";
    public static final double LIFE_BAR_INITIAL_X = 0.0;
    public static final double LIFE_BAR_INITIAL_Y = 0.0;
    public static final double LIFE_BAR_INITIAL_ANGLE = Math.toRadians(0);

    public static final String GAME_OVER_IMG = "GAMEOVER.png";
    public static final double GAME_OVER_X = 250.0;
    public static final double GAME_OVER_Y = 350.0;
    public static final double GAME_OVER_ANGLE = Math.toRadians(0);

    public static final String EXTRA_LIFE_IMG = "extra_life.png";

    public static final String POWER_UP_IMG = "powerup.png";
